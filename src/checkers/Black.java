...
public class Black {
    ...
    public  Vector<Move> ObtainForcedMovesForBlack(int r, int c, Board board)
    {
    ...
    public Vector<Move> CalculateAllForcedMovesForBlack(Board board)
    {
     ...
     * @return
     */
    public  Vector<Move> CalculateAllNonForcedMovesForBlack(Board board){
    ...
    private  Move ForwardLeftForBlack(int r, int c, Board board){
    ...
    // Forward Left Capture for Black
    private  Move ForwardLeftCaptureForBlack(int r, int c, Board board)
    {
    ...
    private  Move ForwardRightForBlack(int r, int c, Board board){
    ...
    private  Move ForwardRightCaptureForBlack(int r, int c, Board board){
    ...
    private  Move BackwardLeftForBlack(int r, int c, Board board){
    ...
    private  Move BackwardLeftCaptureForBlack(int r, int c, Board board){
    ...
    private  Move BackwardRightForBlack(int r, int c, Board board){
    ...
    private  Move BackwardRightCaptureForBlack(int r, int c, Board board){
